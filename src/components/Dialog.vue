            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            class="relative transform overflow-hidden rounded-lg bg-primary-0 text-left shadow-xl outline -outline-offset-1 outline-white/10 transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-8 p-4 flex flex-col items-center justify-center">
                            <slot name="body"></slot>
                            <div class="px-4 mt-6 py-3 flex items-center w-full sm:px-6">
